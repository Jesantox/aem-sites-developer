 ...
 */
MapTo('aem-sites-developer/components/navigation')(NavigationV1Component, {isEmpty: NavigationV1IsEmptyFn});
MapTo('aem-sites-developer/components/separator')(SeparatorV1Component);

MapTo('aem-sites-developer/components/container')(ContainerV1Component, {isEmpty: ContainerIsEmptyFn});
MapTo('aem-sites-developer/components/experiencefragment')(ContainerV1Component, {isEmpty: ContainerIsEmptyFn});

MapTo('aem-sites-developer/components/download')(DownloadV1Component,{isEmpty: DownloadV1IsEmptyFn});
MapTo('aem-sites-developer/components/languagenavigation')(LanguageNavigationV1Component);
MapTo('aem-sites-developer/components/list')(ListV2Component, {isEmpty: ListV2IsEmptyFn});
MapTo('aem-sites-developer/components/breadcrumb')(BreadCrumbV2Component, {isEmpty: BreadCrumbV2IsEmptyFn});
MapTo('aem-sites-developer/components/button')(ButtonV1Component, {isEmpty: ButtonV1IsEmptyFn});
MapTo('aem-sites-developer/components/image')(ImageV2Component, {isEmpty: ImageV2IsEmptyFn});
MapTo('aem-sites-developer/components/title')(TitleV2Component, {isEmpty: TitleV2IsEmptyFn});

MapTo('aem-sites-developer/components/accordion')(AccordionV1Component);
MapTo('aem-sites-developer/components/tabs')(TabsV1Component);
...
LazyMapTo('aem-sites-developer/components/teaser')(TeaserV1Component);
...
LazyMapTo('aem-sites-developer/components/carousel')(CarouselV1Component);
...
LazyMapTo('aem-sites-developer/components/text')(LazyTextModule, TextEditConfig);